...
![Chapter 2 banner image](images/chapter-2-banner-image.png)
...
![chapter-2-yarn-start](images/chapter-2-yarn-start.png)

터미널에 나와있는 대로 브라우저에서 [http://localhost:3000](http://localhost:3000에)에 접속하면 리액트 페이지를 볼 수 있다

![React app](images/chapter-2-react-app.png)
...
![Parent div](images/chapter-2-parent-div.png)
...
![Parent fragment](images/chapter-2-parent-fragment.png)
...
![rendering undefined error](images/chapter-2-rendering-undefined-error.png)
