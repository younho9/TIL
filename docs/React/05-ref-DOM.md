...
![chapter-5-banner.png](images/chapter-5-banner.png)
...
![chapter-5-javascript-validate-result.png](images/chapter-5-javascript-validate-result.png)

암호 0000을 입력하고 Validate 버튼 클릭 결과
...
![chapter-5-react-validate-result.png](images/chapter-5-react-validate-result.png)
...
![chapter-5-scrollbox-result.png](images/chapter-5-scrollbox-result.png)
...
![chapter-5-scroll-to-bottom-result.png](images/chapter-5-scroll-to-bottom-result.png)
