...
![chapter-6-banner.png](images/chapter-6-banner.png)
...
![chapter-6-iteration-sample-result.png](images/chapter-6-iteration-sample-result.png)

원하는 대로 렌더링이 된 것을 확인할 수 있다.

하지만 `F12` 키를 눌러 크롬의 콘솔 창을 확인해 보면 경고 메시지가 나타나는 것을 볼 수 있다.

![chapter-6-iteration-sample-warning.png](images/chapter-6-iteration-sample-warning.png)
